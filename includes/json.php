...
/*
$value[] = array ('pesanerror'=>true,'errorReporting'=>'benar','w'=>50,'h'=>80);

$j 	= new JSON_obj();
echo $j->encode($value);

$json = '[{"pesanerror":true,"errorReporting":"benar","w":50,"h":80}]';
$obj  = $j->decode($json);
echo $obj[0]->{'pesanerror'}; // 1
*/

function jencode($string, $act = 'encode'){
	if(empty($string))
	return false;
